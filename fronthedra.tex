...
\linha{colaboração no posfácio}{\copyrightintroducao}
...
\textit{A primeira versão deste livro foi publicada no Porto,\\
pelas Edições Afrontamento, em 2003.}\\

\textit{Uma segunda versão foi colocada na internet em 2015\\
e em 2018 foi colocada na internet a terceira versão.}\\

\textit{A Editora Hedra publica agora a versão definitiva da obra,\\
que, além de completamente revista, inclui numerosas\\
remodelações e desenvolvimentos.}\\

%A ilustração da capa reproduz o pavimento concebido por Francesco
%Celebrano (1765-1771)\\
%para a capela Sansevero, em Nápoles.



\vfill\textit{Direitos reservados em l\'ingua\\ portuguesa somente para o Brasil}\\\medskip

\vfill\textit{Agradeço a Philippe Bihouée, do Musée des Beaux-Arts\\
de Chartres, uma informação que me permitiu corrigir\\
um erro relativo a uma obra de Maurice de Vlaminck,\\
que constava nas versões de 2003 e 2015 deste livro.}\\
